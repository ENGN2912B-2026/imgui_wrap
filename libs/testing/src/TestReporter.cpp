...
namespace testing
{
  ...
  void TestReporterConsole::generateReport(TestEngine& engine, std::ostream& os)
  {
    ImGuiTestEngineResultSummary summary;
    ImGuiTestEngine_GetResultSummary(engine.getEngine(), &summary);
    ...
    {
      os << "\nFailing tests:\n";
      const auto tests = engine.getEngine()->TestsAll;
  ...
  void TestReporterMarkdown::generateReport(TestEngine& engine, std::ostream& os)
  {
    ImGuiTestEngineResultSummary summary;
    ImGuiTestEngine_GetResultSummary(engine.getEngine(), &summary);
